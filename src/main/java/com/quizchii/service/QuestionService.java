...
public class QuestionService {
    ...
    public QuestionResponse getQuestionById(Long questionId) {
        ...
        QuestionEntity questionEntity = optional.orElseThrow(() -> new BusinessException(HttpStatus.NOT_FOUND, Const.TAG_NOT_FOUND));
    ...
    public QuestionResponse deleteTagByQuestion(Long questionId, Long tagId) {
        ...
        QuestionTagEntity questionTagEntity = optional.orElseThrow(() -> new BusinessException(HttpStatus.NOT_FOUND, Const.TAG_NOT_FOUND));
